...
import { GalaxyService } from '@/bindings/deearthx/core/services';
...
const handleUpload = async () => {
    ...
    try {
        const modids = await GalaxyService.UploadModsFromPaths(droppedFiles.value);
...
const handleSubmit = () => {
    ...
    Modal.confirm({
        ...
        onOk: async () => {
            ...
            try {
                await GalaxyService.SubmitModIDs(modType.value, modidList.value);
